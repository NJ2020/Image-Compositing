...
Original file is located at
    https://colab.research.google.com/drive/1bAA9VdHgPuTlcKn8-r3dSLQU4PD5GITO
"""
...
def in_training_mode(num_epochs = 100, log_dir = "./checkpoints/"):
    ...
    for epoch in range(sess.run(global_step), num_epochs):     
        ...
        logs_dir = log_dir; d_l = 0; g_l = 0; num_iters = 25000;
...
#               NOTE: This is done to avoid running multiple iterations of discriminator step as in the case of WGAN
                _, dis_loss = sess.run([d_trainer, d_loss], feed_dict = {input_A: a_next_image, input_B: b_next_image, lr: 4*curr_lr})   
...
#               Print some statistics
                if(ptr % 10000 == 0):
                    print(str(epoch*75000 + ptr) + ' iterations completed and losses are:')
